...
const classes = {
    'Pepper Bell - Bacterial_spot': 0, 'Pepper Bell - Healthy': 1,
    'Potato - Early Blight': 2, 'Potato - Late Blight': 3, 'Potato - Healthy': 4,
    'Tomato - Bacterial Spot': 5, 'Tomato - Early Blight': 6, 'Tomato - Late Blight': 7,
    'Tomato - Leaf Mold': 8, 'Tomato - Septoria Leaf Spot': 9, 'Tomato - Two Spotted Spider Mite': 10,
    'Tomato - Target Spot': 11, 'Tomato - Tomato Yellow Leaf Curl Virus': 12, 'Tomato - Tomato Mosaic Virus': 13, 'Tomato - Healthy': 14
};
...
const causes = {
    ...
    "The potato plant is healthy.": 4, "The bacterial spot of tomato is caused by Xanthomonas vesicatoria, Xanthomonas euvesicatoria, Xanthomonas gardneri, and Xanthomonas perforans. These bacterial pathogens can enter a garden on contaminated seed and transplants, which may or may not show symptoms.": 5,
    ...
    "ToMV is caused by Tomato mosaic virus, which can overwinter on perennial weeds and is then spread by several insects including aphids, leafhoppers, whiteflies, and cucumber beetles. Both cuttings and divisions from infected plants will be infected. The disease spreads into the plant via minor wounds caused by mechanical injury, insect chewing, and grafting. Leftover plant debris is the most common contagion.": 13, "The tomato plant is healthy.": 14
};
...
["Use a seed piece fungicide treatment labeled for control of late blight. Recommended seed treatments include Revus, Reason, and mancozeb.", "Eliminate sources of inoculum such as hairy nightshade weed species and diseased potatoes.", "Destroy all culled and diseased potatoes.", "Quickly destroy hot spots of late blight.", "Kill vines completely two to three weeks before harvest.", "Applying phosphorous acid to potatoes after harvest and before piling can prevent infection and the spread of late blight in storage.", "Monitor home gardens and market tomatoes near you for late blight. Late blight can move from these local sources to potato fields."], 
["There is no need for treatment as the plant is healthy."], 
["Cultural practices and preventive sprays of copper help to manage bacterial spots.", "Using pathogen-free seeds and disease-free transplants, when possible, is the best way to avoid bacterial spots on tomatoes. Avoiding sprinkler irrigation and cull piles near greenhouse or field operations, and rotating with a nonhost crop also help control the disease.", "Cultural controls and some copper formulations are acceptable for use on organically certified produce.", "Copper-containing bactericides provide partial disease control. Apply at the first sign of disease and repeat at 10 to 14-day intervals when warm, moist conditions prevail. Copper is strictly a protectant and must be applied before an infection occurs. Copper resistance has been observed, but can be somewhat overcome by combining copper with mancozeb."],
["Tomatoes have early blight that requires immediate attention before the disease takes over the plants. Thoroughly spray the plant (including bottoms of leaves )with Bonide Liquid Copper Fungicide concentrate or Bonide Tomato & Vegetable. Both of these treatments are organic.", "A day after treatment, remove the lower branches with a sharp razor blade knife. Clean your knife with rubbing alcohol before trimming the next plant to prevent the spread of the disease. Repeat fungicide treatments every 7 to 14 days.", "Read the fungicide label instructions carefully before using.", "Do not spray pesticides, fungicides, fertilizers, or herbicides at a high temperature, as you can damage your plants. Water your plants the day before spraying. Hydration is important!."],
["Tomato varieties resistant to certain races of the late blight fungus are grown where the disease occurs regularly.", "Remove any nearby diseased tomato plants and nightshades.", "Check transplants to ensure they are free of late blight before planting.", "Avoid sprinkler irrigation, if possible, because it favors the development of late blight.", "Fungicides are generally needed only if the disease appears during a time of year when rain is likely or overhead irrigation is practiced.", "Disc tomato fields in fall to eliminate a winter reservoir for the fungus."],
["If you observe symptoms in the greenhouse, remove the diseased plants and surrounding plants to prevent pathogen spread. Dispose of infected plant material and sterilize all equipment used in that greenhouse.", "Nutrients and disease pressures can build up in high tunnels, so rotate crops and move tunnels regularly.", "Make sure the seed is clean and purchased from a reputable source.", "Use drip irrigation and avoid watering foliage.", "Keep the night temperature in the greenhouse higher than the outside temperature to avoid dew formation on the foliage.", "Remove crop residue at the end of the season. Burn it or bury it away from tomato production areas."],
["If the disease is caught early, the lower infected leaves can be removed and burned or destroyed. However, removing leaves above where the fruit has formed will weaken the plant and expose the fruit to sunscald. At the end of the season, collect all foliage from infected plants and dispose of or bury it. Do not compost diseased plants.", "Mulching will reduce splashing soil, which may contain fungal spores associated with debris. Apply mulch after the soil has warmed.", "Overhead watering facilitates infection and spreads the disease. Use a soaker hose at the base of the plant to keep the foliage dry. Water early in the day.", "Use crop rotation(Next year do not plant tomatoes in the location where diseased tomatoes grew. Wait 1–2 years before replanting tomatoes in these areas)."],
["Avoid weedy fields and do not plant eggplant adjacent to legume forage crops.", "Do not over-fertilize.", "Overhead irrigation or prolonged periods of rain can help reduce populations.", "Apply a pesticide specific to mites called a miticide. Ideally, start treating for two-spotted mites before your plants are seriously damaged. Apply the miticide for control every 7 days or so. Since mites can develop resistance to chemicals, switch to another type of miticide after three applications."],
["Remove a few branches from the lower part of the plants to allow better airflow at the base.", "Remove and burn the lower leaves as soon as the disease appears, especially after the lower fruit trusses have been picked.", "Keep plots free from weeds, as some may be hosts of the fungus.", "Do not use overhead irrigation, otherwise, it will create conditions for spore production and infection.", "Collect and burn as much of the crop as possible when the harvest is complete.", "Practice crop rotation, leaving 3-years before replanting tomatoes on the same land."],
["Inspect plants for whitefly infestations two times per week. If whiteflies are beginning to appear, spray with azadirachtin (Neem), pyrethrin, or insecticidal soap. For more effective control, it is recommended that at least two of the above insecticides be rotated at each spraying. Follow label directions closely for dosage rates, spray intervals, and precautions. Spray the undersides of the leaves thoroughly.", "Symptomatic plants should be carefully covered by a clear or black plastic bag and tied at the stem at the soil line. Cut off the plant below the bag and allow the bag with plant and whiteflies to desiccate to death on the soil surface for 1-2 days before placing the plant in the trash. Do not cut the plant off or pull it out of the garden and toss it on the compost! The goal is to remove the plant reservoir of virus from the garden and to trap the existing virus-bearing whiteflies so they do not disperse onto other tomatoes.", "Use a neonicotinoid insecticide, such as dinotefuran (Venom) imidacloprid (AdmirePro, Alias, Nuprid, Widow, and others), or thiamethoxam (Platinum), as a soil application or through the drip irrigation system at transplanting of tomatoes."],
["Once plants are infected, there is no cure for mosaic viruses. Because of this, prevention is key! However, if plants in your garden do show symptoms of having mosaic viruses, here's how to minimize the damage:", "Remove all infected plants and destroy them. Do not put them in the compost pile, as the virus may persist in infected plant matter. Burn infected plants or throw them out with the garbage.", "Monitor the rest of your plants closely, especially those located near infected plants.", "Disinfect gardening tools after every use. Keep a bottle of a weak bleach solution or another antiviral disinfectant to wipe your tools.", "Plant virus-resistant varieties in your garden.", "Mosaic viruses are mostly spread by insects, especially aphids and leafhoppers. You can try covering your plants with a floating row cover or aluminum foil mulches to prevent these insects from infecting your plant.", "Control your weeds. Some types may serve as hosts for the disease, and when aphids and other insects feed on these plants, they will spread the viruses to your garden plants.", "To avoid seed-borne mosaic viruses, soak seeds of susceptible plants in a 10% bleach solution before planting."], 
["There is no need for treatment as the plant is healthy."]];
...
function loadModelAndPredict(image) {
    tf.loadLayersModel('http://localhost:8002/model.json').then(pretrainedModel => {
